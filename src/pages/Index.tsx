...
const Index = () => {
  ...
  const [selectedType, setSelectedType] = useState<'box' | 'sphere' | 'cylinder'>('box');
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                className="w-full"
                variant={selectedType === 'box' ? 'default' : 'outline'}
              >
              ...
              <Button
                ...
                className="w-full"
                variant={selectedType === 'sphere' ? 'default' : 'outline'}
              >
              ...
              <Button
                ...
                className="w-full"
                variant={selectedType === 'cylinder' ? 'default' : 'outline'}
              >
